    ...
    export default {
        data() {
            return {
                ...
                endAirportEName: '',
                endAirportEName: '',
                rulesData: SpecialTravellerRules.SICKEN_PEOPLE,
                canShowRules: false,
                //图片地址存储
                imgArr: [],
                //传参图片地址
            ...
            sucCallback_1(data) {
                ...
                if(data.resultCode === ResultCode.SUCCESS){
                    ...
                    controller.open({
                        ...
                        data: {title: this.title, type: SuccType.APPLY_SUCC, pageName: Page.passengers.sickenPeople.winName, id: id},
                        closeLastPage: true
                    });
                } else {
