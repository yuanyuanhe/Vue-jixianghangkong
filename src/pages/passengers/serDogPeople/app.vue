        ...
        <div class="main" :class='{mainHasBottom : !isDetailPage}'>
            ...
            <div class="container">
                ...
                <!-- 服务犬信息 -->
                 ...
                 <div class="post-wrapper">
                    <div class="writeInformation-title">服务犬信息</div>

                    <ul>

                        <li class="every-insurance clearfix" v-if="isDetailPage ? isDetailPage && psgInfo.serviceType === SerDog.CANI : true">
                            <div class="label-content flexbox">
                                <div class="insurance-information flex-1">
                                    <div>
                                        <span class="name">导听犬</span>
                                    </div>
                                </div>
                            </div>
                            <label class="select-checkbox clearfix" v-show="!isDetailPage">
                                <input type="radio" :value="SerDog.CANI" v-model="psgInfo.serviceType" class="label-checkbox" name="dogs">
                                <span class="select-btn"></span>
                            </label>
                        </li>

                        <li class="every-insurance clearfix" v-if="isDetailPage ? isDetailPage && psgInfo.serviceType === SerDog.GUID : true">
                            <div class="label-content flexbox">
                                <div class="insurance-information flex-1">
                                    <div>
                                        <span class="name">导盲犬</span>
                                    </div>
                                </div>
                            </div>
                            <label class="select-checkbox clearfix" v-show="!isDetailPage">
                                <input type="radio" :value="SerDog.GUID" v-model="psgInfo.serviceType" class="label-checkbox" name="dogs">
                                <span class="select-btn"></span>
                            </label>
                        </li>
                    </ul>
    ...
    export default {
        data() {
            return {
                ...
                endAirportEName: '',
                endAirportEName: '',
                rulesData: SpecialTravellerRules.SERDOG_PEOPLE,
                canShowRules: false,
                //图片地址存储
                imgArr: [],
                //接口图片存储地址
        ...
        computed: {
            submitBtnCls() {
                if (this.checkInput && this.psgInfo.passengerName && this.psgInfo.certType && this.psgInfo.certNo &&
                    this.psgInfo.flightDate && this.psgInfo.depAirportName && this.psgInfo.arrAirportName && this.psgInfo.serviceType &&
        ...
        methods: {
            ...
            sucCallback_2(res) {
                ...
                this.psgInfo.serviceType = res.objData.serviceDogType
            ...
            submitApply() {
                ...
                if(that.canClickBtn && that.valify()){
                    ...
                    if(that.imgArr.length == 0){
                        controller.getJSON({
                            method: 'POST',
                            url: requesturl.PASSENGERS.SERDOG,
            ...
            sucCallback_1(data) {
                ...
                if(data.resultCode === ResultCode.SUCCESS){
                    ...
                    controller.open({
                        ...
                        data: {title: this.title, type: SuccType.APPLY_SUCC, pageName: Page.passengers.serDogPeople.winName, id: id},
                        closeLastPage: true
                    });
                } else {
            ...
            createParams(){
                ...
                return {
                    "request": {
                        ...
                        "serviceType": ServiceCode.PETC,
                        "attachment":_that.attachment,
                        "serviceDogType":_that.psgInfo.serviceType
