                    ...
                    <ul>
                        ...
                        <li class="flexbox">
                            <label class="flexbox" :class="{labelColor: isDetailPage}">
                                ...
                                <input type="number" pattern="[0-9]*" class="all-input-style flex-1" v-model='psgInfo.amount' :readonly='isDetailPage'>
                                <span>L/min</span>
                            </label>
                        </li>
                    ...
                    <ul>
                        <li v-if="!isDetailPage || psgInfo.ticketNo">
                            <label class="flexbox">
                                ...
                                <input type="text" placeholder="选填，若已购票请输入票号" class="all-input-style flex-1" v-model="psgInfo.ticketNo" :readonly='isDetailPage'>
                            </label>
                        </li>
...
<script>
    ...
    import { RegEnum, Verify, SuccType, ResultCode,SelType,ServiceCode,FILETYPE } from 'common/logic/enum'
    ...
    export default {
        data() {
            return {
                ...
                // 到达机场的三字码
                endAirportEName: '',
                rulesData: SpecialTravellerRules.USEOXY_PEOPLE,
                canShowRules: false,
        ...
        computed: {
            submitBtnCls() {
                if (this.checkInput && this.psgInfo.passengerName && this.psgInfo.certType && this.psgInfo.certNo &&
                    ...
                    this.psgInfo.keeper && this.psgInfo.keeperHandphone && this.psgInfo.keeperEmail && this.psgInfo.amount) {
        ...
        methods: {
            ...
            sucCallback_2(res) {
                ...
                this.psgInfo.amount = res.objData.userOxygen
            ...
            // 提交申请
            submitApply() {
                if(!(/(^[1-9]\d*$)/.test(this.psgInfo.amount))){
                    controller.toast({
                        str:"请输入正确的用氧量",
                        times:1000
                    })
                ...
                if(this.psgInfo.amount.length>4){
                    controller.toast({
                        str:"乘机人用氧量有误",
                        times:1000
                    })
                ...
                return {
                    "request": {
                        ...
                        "passengerInfo": {
                            ...
                            "OxygenUse": _that.psgInfo.amount
                        },
                        "flightInfo": {
                ...
                if(res.resultCode === ResultCode.SUCCESS){
                    ...
                    controller.open({
                        ...
                        data: {
                            ...
                            pageName: Page.passengers.useoxyPeople.winName,
                            id: id
                        },
                        closeLastPage: true
                    })
