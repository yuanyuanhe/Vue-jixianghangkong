    ...
    export default {
        data() {
            return {
                ...
                // 到达机场的三字码
                endAirportEName: '',
                rulesData: SpecialTravellerRules.CHILD,
                canShowRules: false
            }
        },
        components: {
                    ...
                    .then((res) => {
                        ...
                        if (res.resultCode === ResultCode.SUCCESS) {
                            ...
                            controller.open({
                                ...
                                data: {title: this.title, type: SuccType.ORDER_SUCC, pageName: Page.passengers.child.winName, id: id},
                                closeLastPage: true
                            });
                        } else {
                            controller.toast({str: res.resultInfo});
            ...
            selectAge() {
                ...
                if (!this.psgAgePicker) {
                    this.psgAgePicker = this.$createPicker({
                        title: '选择年龄',
                        data: [juneyaoair.selCount(SelType.child)],
                        onSelect: (selectedVal, selectedIndex, selectedText) => {
