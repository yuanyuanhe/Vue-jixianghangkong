                        ...
                        <li>
                            <div class="flexbox">
                                <div class="all-inputBox" @click="selectCard('send')">
                                    <span v-text="juneyaoair.CardType(psgInfo.sendCertType)">身份证</span>
                                    <div class="btndown" v-if='!isDetailPage'></div>
                                </div>
                                <input 
                                type="text" 
    ...
    export default {
        data() {
            return {
                ...
                // 到达机场的三字码
                endAirportEName: '',
                rulesData: SpecialTravellerRules.YOUNG,
                canShowRules: false
            }
        },
        components: {
                    ...
                    .then((res) => {
                        ...
                        if (res.resultCode === ResultCode.SUCCESS) {
                            ...
                            controller.open({
                                ...
                                data: {title: this.title, type: SuccType.ORDER_SUCC, pageName: Page.passengers.young.winName, id: id},
                                closeLastPage: true
                            });
                        } else {
            ...
            selectAge() {
                ...
                if (!this.psgAgePicker) {
                    this.psgAgePicker = this.$createPicker({
                        title: '选择年龄',
                        data: [juneyaoair.selCount(SelType.young)],
                        onSelect: (selectedVal, selectedIndex, selectedText) => {
