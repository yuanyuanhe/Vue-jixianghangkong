    ...
    export default {
        data() {
            return {
                ...
                endAirportEName: '',
                endAirportEName: '',
                rulesData: SpecialTravellerRules.ORGANTRA,
                canShowRules: false,
                //图片地址存储
                imgArr: [],
                //传参图片地址
        ...
        methods: {
           openImg(index,data){
            ...
            submitApply() {
                console.log(FILETYPE.SPECIALSERVICE)
                let that = this;
            ...
            sucCallback_1(data) {
                ...
                if(data.resultCode === ResultCode.SUCCESS){
                    ...
                    controller.open({
                        ...
                        data: {title: this.title, type: SuccType.APPLY_SUCC, pageName: Page.passengers.organTra.winName, id: id},
                        closeLastPage: true
                    });
                } else {
