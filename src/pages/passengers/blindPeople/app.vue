            ...
            <div class="container">
                ...
                <div class="post-wrapper">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="flexbox">
                                <div class="all-inputBox" @click="selectCard()">
    ...
    export default {
        data() {
            return {
                ...
                // 到达机场的三字码
                endAirportEName: '',
                rulesData: SpecialTravellerRules.BLIND_PEOPLE,
                canShowRules: false
            }
        },
        components: {
        ...
        methods: {
            ...
            initPage() {
                ...
                // 设置H5 title
                //this.titleStyle.title = this.$filters.formatPsgTitle(this.title, this.isDetailPage);
            },
            // 请求详情数据
            getDetailInfor() {
                const that = this;
            ...
            sucCallback_1(data) {
                ...
                if(data.resultCode === ResultCode.SUCCESS){
                    ...
                    controller.open({
                        ...
                        data: {title: this.title, type: SuccType.ORDER_SUCC, pageName: Page.passengers.blindPeople.winName, id: id},
                        closeLastPage: true
                    });
                } else {
