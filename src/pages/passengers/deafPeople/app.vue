    ...
    export default {
        data() {
            return {
                ...
                // 到达机场的三字码
                endAirportEName: '',
                rulesData: SpecialTravellerRules.DEAF_PEOPLE,
                canShowRules: false
            }
        },
        components: {
            ...
            sucCallback_1(data) {
                ...
                if(data.resultCode === ResultCode.SUCCESS){
                    ...
                    controller.open({
                        ...
                        data: {title: this.title, type: SuccType.ORDER_SUCC, pageName: Page.passengers.deafPeople.winName, id: id},
                        closeLastPage: true
                    });
                } else {
